...
function getHelp(){
    ...
    questionHelpList = [
        ...
        'Ingat, sudut yang sehadap arahnya sama. Contoh, jika ada sudut yang arahnya ke kiri atas, maka yang sehadap juga ke arah kiri atas',
        'Ingat, sudut dalam artinya berada di antara dua garis pararel, sudut berseberangan artinya melewati garis yang memotong',
        'Ingat, sudut luar artinya tidak berada di antara dua garis pararel, sudut berseberangan artinya melewati garis yang memotong',
        'Ingat, sudut dalam artinya berada di antara dua garis pararel, sudut sepihak artinya tidak melewati garis yang memotong',
        'Ingat, sudut luar artinya tidak berada di antara dua garis pararel, sudut sepihak artinya tidak melewati garis yang memotong'];
